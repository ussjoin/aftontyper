...
* Voltage Converter (for microcontroller): [Adafruit Verter](https://www.adafruit.com/product/2190). Perfect for this because it can supply a steady 5v across the entire range of a 6v (nominal) LFP battery. It's not *enormously* efficient, but it does what it say on the tin and I'm not trying to source giant amps out of it, so it works wonderfully.
